...
if [[  $Check == "yes" ]];then 
cp /home/hisoft/feeds/$Date/$SiteName.xml  /home/hisoft/feeds2review/
rm -fr  /home/hisoft/feeds2review/$SiteName.tgz
ls -al /home/hisoft/feeds2review/$SiteName*
echo "congratulate, The $SiteName.xml is in $Feedname"
else
echo "Old Xml size and new Xml size is not the same !!"
fi 
...
if [[ $Check == "yes" ]];then 
cp /home/hisoft/feeds/$Date/$SiteName*.xml  /home/hisoft/feeds2review/
rm -rf /home/hisoft/feeds2review/$SiteName*.tgz
ls -al /home/hisoft/feeds2review/$SiteName*
echo "congratulate, The $SiteName.xml is in $Feedname"
else
echo "Old Xml size and new Xml size is not the same !!"
